...
3. Install Sass
	The project uses Sass for styling. If it's not installed globally, you can install it using npm:
	npm install -g sass

4. Compile Sass:
	To compile the Sass files into CSS, run the following command in the project directory:
	sass --watch scss:css

## Usage

1. Start a local server:
	If you want to run the project locally, you can use a simple HTTP server to serve the files. You can install a package like live-server:
